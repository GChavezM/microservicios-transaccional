...
public class RegisterJournal {
    ...
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
    public void registerSale(Map<String, String> saleData) {
        ...
        JournalDto debitEntry = new JournalDto(
            "10101", // Código de cuenta para Cuentas por Cobrar
            "Accounts Receivable",
            "Sale to " + customerId,
            amount,
            "D", // Débito
        ...
        JournalDto creditEntry = new JournalDto(
            "40101", // Código de cuenta para Ingresos por Ventas
            "Sales Revenue",
            "Sale to " + customerId,
            amount,
            "C", // Crédito
